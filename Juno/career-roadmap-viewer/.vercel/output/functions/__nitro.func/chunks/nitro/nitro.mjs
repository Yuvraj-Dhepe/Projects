...
storage.mount('cache', unstorage_47drivers_47memory({"driver":"memory","ttl":86400}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "dfb4e3ae-ca62-4c80-a6e7-7c7503b3cd63",
...
const handlers = [
  ...
  { route: '/api/diagrams/**', handler: _lazy_x_SSut, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_x_SSut, lazy: true, middleware: false, method: undefined }
];
...
export { withTrailingSlash as A, withoutTrailingSlash as B, listener as C, getQuery as a, setResponseHeader as b, getResponseStatusText as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getRouterParam as g, createError$1 as h, getRouteRules as i, joinRelativeURL as j, useNitroApp as k, createHooks as l, getContext as m, createRouter$1 as n, defu as o, hasProtocol as p, joinURL as q, sanitizeStatusCode as r, setResponseStatus as s, toRouteMatcher as t, useRuntimeConfig as u, isScriptProtocol as v, withQuery as w, executeAsync as x, hash$1 as y, parseQuery as z };
