...
You can click the gray buttons, starting with
"Highlight the function" to follow along.
"""

# region ——————————————————————————
# Part 1: Ask a question about code [Ctrl+L] ——————————————————————————
...
# Ready to learn more? Check out the Continue documentation:
